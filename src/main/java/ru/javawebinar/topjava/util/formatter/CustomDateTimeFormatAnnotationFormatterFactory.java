...
public class CustomDateTimeFormatAnnotationFormatterFactory implements AnnotationFormatterFactory<CustomDateTimeFormatter> {
    ...
    private Formatter<?> getFormatter(CustomDateTimeFormatter annotation, Class<?> fieldType) {
